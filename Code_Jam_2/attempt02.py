...
while cap.isOpened():
    ...
    for cnt in (contours):
        ...
        cv2.putText(frame1, 'A', (int(x1_o), int(y1_o)+100), cv2.FONT_HERSHEY_SIMPLEX, 0.9, (0,255,0), 2)
        cv2.putText(frame1, 'B', (int(x2_o), int(y2_o)+100), cv2.FONT_HERSHEY_SIMPLEX, 0.9, (0,255,0), 2)
